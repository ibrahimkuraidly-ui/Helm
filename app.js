  ...
  document.getElementById('modal-root').innerHTML = `
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal">
        ...
        <div style="text-align:center;margin-bottom:${Math.abs(balance) > 0.005 ? '8px' : '16px'}">
        ...
        ${Math.abs(balance) > 0.005 ? `<div style="text-align:center;margin-bottom:16px"><button class="btn btn-secondary" style="font-size:12px;padding:4px 14px;opacity:0.8" onclick="resetCardBalance('${card}',${balance})">Reset to $0</button></div>` : ''}
        <div class="field">
...
function fetchGoldPrice() {
  ...
  // Auto-refresh every 6 hours — restart timer each call so only one runs at a time
  clearTimeout(_goldTimer);
  _goldTimer = setTimeout(fetchGoldPrice, 6 * 60 * 60 * 1000);
}
      ...
      <div class="modal">
        ...
        <div id="wk-cardio-section" style="display:none">
          <div style="display:flex;align-items:flex-end;gap:6px;margin-bottom:4px">
            <div class="field" style="flex:1;margin:0"><label>Activity</label><input type="text" id="wk-cardio-activity" placeholder="Type or pick…" autocomplete="off"></div>
            <button class="wk-list-btn" onclick="wkToggleList(this,'cardio')">☰</button>
          </div>
